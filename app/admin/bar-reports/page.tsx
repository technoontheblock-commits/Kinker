...
export default function BarReportsPage() {
  ...
  const openStockModal = (eventId: string, bar: EventBar, type: 'initial' | 'final') => {
  ...
  const closeStockModal = () => {
    ...
    if (stockModal.eventId) {
      fetchEventStockRecords(stockModal.eventId)
    }
  }
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <StockModal
        ...
        eventId={stockModal.eventId}
        barId={stockModal.barId}
        barName={stockModal.barName}

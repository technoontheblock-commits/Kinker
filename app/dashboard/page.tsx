          ...
          return (
            <Link key={stat.id} href={stat.href}>
              <motion.div
                ...
                className="bg-neutral-900 rounded-xl p-4 md:p-6 border border-white/10 hover:border-red-500/50 transition-all"
              >
                <div className="flex items-center justify-between mb-4">
                  <div className={`w-10 h-10 md:w-12 md:h-12 bg-${stat.color}-500/20 rounded-lg flex items-center justify-center`}>
        ...
        <div className="bg-neutral-900 rounded-xl p-4 md:p-6 border border-white/10">
          ...
          <div className="space-y-4">
            {recentOrders.map((order) => (
              <div key={order.id} className="flex items-center gap-3 md:gap-4 p-3 md:p-4 bg-black/30 rounded-lg">

        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-black/50 rounded-lg border border-white/5">
              <h3 className="text-red-500 font-semibold mb-2">Tuesday</h3>
              <p className="text-2xl font-bold text-white">{clubInfo.openingHours.tuesday}</p>
              <p className="text-white/50 text-sm mt-2">Techno Tuesday</p>
            </div>
            <div className="p-6 bg-black/50 rounded-lg border border-white/5">

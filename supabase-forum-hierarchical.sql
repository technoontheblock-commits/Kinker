...
-- ============================================
-- 3. POSTS (Reference subcategory, not category)
-- ============================================
...
INSERT INTO forum_categories (name, slug, description, icon, color, sort_order) VALUES
  ('Kinker Club', 'kinker-club', 'Alles rund um den Kinker Club Basel', 'Building', '#FF4D00', 1),
  ('Veranstaltungen', 'veranstaltungen', 'Events, Partys und Ankündigungen', 'Calendar', '#8B5CF6', 2),
  ('Community', 'community', 'Community-Bereich für Member', 'Users', '#10B981', 3),
  ('Support', 'support', 'Hilfe und Support-Bereich', 'HelpCircle', '#3B82F6', 4)

-- ============================================
-- FORUM SYSTEM - COMPLETE FIX FOR EXISTING TABLES
-- ============================================

-- ============================================
-- 1. DROP OLD TABLES (CAREFUL - DATA LOSS!)
-- ============================================
-- Only drop if you want to start fresh
-- Uncomment the following lines if you want to delete existing forum data:
...
-- ============================================
-- 2. FIX EXISTING forum_categories TABLE
-- ============================================
...
-- ============================================
-- 3. FIX EXISTING forum_posts TABLE (if exists with old schema)
-- ============================================

DO $$
BEGIN
    -- Check if forum_posts exists with old schema (has 'category' column)
...
-- ============================================
-- 5. CREATE POSTS TABLE (NEW SCHEMA)
-- ============================================
...
CREATE POLICY "forum_categories_read" ON forum_categories FOR SELECT USING (COALESCE(is_active, true));
